...
API_KEY = "AIzaSyATD0_W6y7USjab-DgeZ5JMRwiYPl0DUoc"  # <--- PASTE YOUR GEMINI API KEY HERE
...
def select_best_documents(user_query, document_descriptions, searcher_results):
    ...
    if not selected_ids:
        print("[Warning] Librarian AI failed. Using all documents as fallback.")
        return list(document_descriptions.keys())
    return selected_ids
